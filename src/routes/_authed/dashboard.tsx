...
function DashboardPage() {
  ...
  // bills one member fronted for the others (rent/bazar/utility bills paid
  // by one person on behalf of subscribers). This always nets to exactly
  // zero by construction: every taka one member is owed is a taka someone
  // else owes them, nothing is owed to or by "the mess" itself.
