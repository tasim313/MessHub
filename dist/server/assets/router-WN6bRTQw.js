import { T as reactExports, v as functionalUpdate$1, b as arraysEqual, i as createLRUCache, G as isPromise, H as isRedirect, F as isNotFound, A as invariant, h as createControlledPromise, a0 as rootRouteId, I as isServer$1, f as compileDecodeCharMap, a2 as trimPath, $ as rewriteBasepath, g as composeRewrites, S as processRouteTree, Q as processRouteMasks, _ as resolvePath, d as cleanPath, a4 as trimPathRight, P as parseHref, q as executeRewriteInput, B as isDangerousProtocol, U as redirect, u as findSingleMatch, l as deepEqual$1, D as DEFAULT_PROTOCOL_ALLOWLIST, c as buildRouteBranch, z as interpolatePath, N as nullReplaceEqualDeep, W as replaceEqualDeep$1, L as last, k as decodePath, s as findFlatMatch, t as findRouteMatch, y as hasKeys, r as executeRewriteOutput, n as encodePathLikeUrl, a3 as trimPathLeft, J as joinPaths, a6 as useRouter, m as dummyMatchContext, M as matchContext, x as getDefaultExportFromCjs, Y as requireReactDom, p as exactPathTest, V as removeTrailingSlash, a as React2, K as jsxRuntimeExports, E as isModuleNotFoundError, a5 as useHydrated, o as escapeHtml, C as isInlinableStylesheet, w as getAssetCrossOrigin, Z as resolveManifestAssetLink, O as Outlet } from "./server-Be2prDnF.js";
...
var Query$1 = class Query extends Removable {
  #queryType;
  #initialState;
  #revertState;
  #cache;
...
var Mutation$1 = class Mutation extends Removable {
  #client;
  #observers;
  #mutationCache;
  #retryer;
...
const appCss = "/assets/styles-BuqtXvUR.css";
...
class __PRIVATE_SetMutation extends Mutation2 {
  constructor(e, t, n, r = []) {
...
class __PRIVATE_PatchMutation extends Mutation2 {
  constructor(e, t, n, r, i = []) {
...
class __PRIVATE_DeleteMutation extends Mutation2 {
  constructor(e, t) {
...
class __PRIVATE_VerifyMutation extends Mutation2 {
  constructor(e, t) {
...
class CollectionReference extends Query2 {
  /** @hideconstructor */
  constructor(e, t, n) {
...
class QueryFieldFilterConstraint extends QueryConstraint {
  ...
  _apply(t) {
    ...
    return __PRIVATE_validateNewFieldFilter(t._query, e), new Query2(t.firestore, t.converter, __PRIVATE_queryWithAddedFilter(t._query, e));
  }
  _parse(t) {
...
class QueryCompositeFilterConstraint extends AppliableConstraint {
  ...
  _apply(t) {
    ...
    })(t._query, e), new Query2(t.firestore, t.converter, __PRIVATE_queryWithAddedFilter(t._query, e)));
  }
...
class QueryOrderByConstraint extends QueryConstraint {
  ...
  _apply(t) {
    ...
    return new Query2(t.firestore, t.converter, __PRIVATE_queryWithAddedOrderBy(t._query, e));
  }
}
...
function onSnapshot(t, ...e) {
  ...
  if (t instanceof DocumentReference) i = __PRIVATE_cast(t.firestore, Firestore), c = __PRIVATE_newQueryForPath(t._key.path), o = {
    ...
    const n2 = __PRIVATE_cast(t, Query2);
...
function useCollection(path, constraints = []) {
  ...
  reactExports.useEffect(() => {
    const q2 = query(collection(db, path), ...constraints);
...
async function updateDocIn(path, id, data) {
  return updateDoc(doc(db, path, id), data);
}
async function deleteDocFrom(path, id) {
  return deleteDoc(doc(db, path, id));
}
async function setDocIn(path, id, data) {
...
async function loadOrCreateProfile(u, nameOverride, requestedRole) {
  const ref = doc(db, "users", u.uid);
  const snap = await getDoc(ref);
  let profile;
  if (snap.exists()) {
    profile = { uid: u.uid, ...snap.data() };
  } else {
    const ownerSnap = await getDoc(doc(db, "meta", "owner"));
    const isFirst = !ownerSnap.exists();
    const role = isFirst ? "owner" : requestedRole === "manager" ? "manager" : "member";
    profile = {
      uid: u.uid,
      email: u.email,
...
function AuthProvider({ children }) {
      ...
      if (u) {
        try {
          ...
          if (p.status === "suspended" || p.status === "removed" || p.active === false) {
            ...
            setProfile(null);
            setProfileError(
              p.status === "removed" ? "Your account has been removed by the admin." : "Your account has been suspended by the admin."
            );
            setLoading(false);
            return;
          }
          ...
          setProfileError(e.message || "Profile sync failed");
        }
      } else {
        setProfile(null);
        setProfileError(null);
  ...
  const value = {
    ...
    signup: async (email, password, name2, requestedRole) => {
      const cred = await createUserWithEmailAndPassword(auth, email, password);
      await updateProfile(cred.user, { displayName: name2 });
      await loadOrCreateProfile(cred.user, name2, requestedRole);
    },
    adminCreateUser: async ({ email, password, name: name2, role }) => {
      const secondaryAuth = getSecondaryAuth();
      const cred = await createUserWithEmailAndPassword(secondaryAuth, email, password);
      await updateProfile(cred.user, { displayName: name2 });
      await loadOrCreateProfile(cred.user, name2, role);
...
const Route$c = createRootRouteWithContext()({
  head: () => ({
    meta: [
      ...
      { title: "MessHub — Bachelor Mess Management" },
      { name: "description", content: "Manage meals, bazar, utilities and dues for your Dhaka bachelor mess." },
      { property: "og:title", content: "MessHub — Bachelor Mess Management" },
      { property: "og:description", content: "Manage meals, bazar, utilities and dues for your Dhaka bachelor mess." },
...
const $$splitComponentImporter$b = () => import("./signup-CkYvNIXu.js");
const Route$b = createFileRoute("/signup")({
  component: lazyRouteComponent($$splitComponentImporter$b, "component")
});
const $$splitComponentImporter$a = () => import("./login-dRfjffg5.js");
const Route$a = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$a, "component")
});
const $$splitComponentImporter$9 = () => import("./_authed-BI1hhddi.js");
const Route$9 = createFileRoute("/_authed")({
  component: lazyRouteComponent($$splitComponentImporter$9, "component")
});
const $$splitComponentImporter$8 = () => import("./index-vCgE7d8R.js");
const Route$8 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$8, "component")
});
const $$splitComponentImporter$7 = () => import("./utilities-CDIBwcpC.js");
const Route$7 = createFileRoute("/_authed/utilities")({
  component: lazyRouteComponent($$splitComponentImporter$7, "component")
});
const $$splitComponentImporter$6 = () => import("./reports-BGe5jbiE.js").then((n) => n.r);
const Route$6 = createFileRoute("/_authed/reports")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import("./members-C3vuESRO.js");
const Route$5 = createFileRoute("/_authed/members")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./meals-IVwphjru.js");
const Route$4 = createFileRoute("/_authed/meals")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./deposits-DS2HJbaL.js");
const Route$3 = createFileRoute("/_authed/deposits")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./dashboard-Di6tompp.js");
const Route$2 = createFileRoute("/_authed/dashboard")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./bazar-DWFkILdK.js");
const Route$1 = createFileRoute("/_authed/bazar")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./admin-YAltXLrP.js");
const Route2 = createFileRoute("/_authed/admin")({
...
const AuthedUtilitiesRoute = Route$7.update({
  id: "/utilities",
  path: "/utilities",
  getParentRoute: () => AuthedRoute
});
const AuthedReportsRoute = Route$6.update({
  id: "/reports",
  path: "/reports",
  getParentRoute: () => AuthedRoute
});
const AuthedMembersRoute = Route$5.update({
  id: "/members",
  path: "/members",
  getParentRoute: () => AuthedRoute
});
const AuthedMealsRoute = Route$4.update({
  id: "/meals",
  path: "/meals",
  getParentRoute: () => AuthedRoute
});
const AuthedDepositsRoute = Route$3.update({
  id: "/deposits",
  path: "/deposits",
  getParentRoute: () => AuthedRoute
});
const AuthedDashboardRoute = Route$2.update({
  id: "/dashboard",
  path: "/dashboard",
  getParentRoute: () => AuthedRoute
});
const AuthedBazarRoute = Route$1.update({
  id: "/bazar",
  path: "/bazar",
  getParentRoute: () => AuthedRoute
});
const AuthedAdminRoute = Route2.update({
  id: "/admin",
  path: "/admin",
  getParentRoute: () => AuthedRoute
});
