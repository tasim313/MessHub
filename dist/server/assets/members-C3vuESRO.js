...
import { f as useAuth, h as useCollection, t as toast, u as updateDocIn, a as addDocTo, b as deleteDocFrom } from "./router-WN6bRTQw.js";
...
function MembersPage() {
  ...
  const sortedMembers = reactExports.useMemo(() => [...members].sort((a, b) => a.name.localeCompare(b.name)), [members]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-6", children: sortedMembers.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-12 text-center", children: [
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid gap-3 sm:grid-cols-2 lg:grid-cols-3", children: sortedMembers.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-4", children: [
